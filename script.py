...
# for i in range(n):
#     for j in range(m):
#         matrix[i][j] = int(input(f"Enter the {i+1}th row {j+1} column: "))
#
#
# for i in range(n):
#     for j in range(m):
...
def populate_data():
    with transaction.atomic():
        ...
        # Retrieve users in order (first 10 are patients, next 10 are doctors)
        ...
        # Create Feedbacks
        feedback_data = [
            Feedback(content='Excellent care, very satisfied.', rate=5, appointment=appointments[2], created_at=parse_datetime('2023-07-03 13:00:00')),
            Feedback(content='Very professional and kind.', rate=4, appointment=appointments[3], created_at=parse_datetime('2023-07-04 15:00:00')),
            Feedback(content='Quick and efficient service.', rate=4, appointment=appointments[6], created_at=parse_datetime('2023-07-07 11:00:00')),
            Feedback(content='Average experience.', rate=3, appointment=appointments[9], created_at=parse_datetime('2023-07-10 14:00:00')),
            Feedback(content='Not satisfied with the waiting time.', rate=2, appointment=appointments[18], created_at=parse_datetime('2023-07-19 13:00:00')),
        ]
...
# To execute the population, you could call:
